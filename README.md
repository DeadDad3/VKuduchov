...
- ID бесед - не обязательное поле, используется для более точной настройки, если вы хотите не видеть сообщения от человека лишь в конкретных беседах. ID беседы есть в ссылке на саму беседу, например https://vk.com/im/convo/2000000218?entrypoint=list_all, где о, что после convo, то есть 2000000218 это ID.
